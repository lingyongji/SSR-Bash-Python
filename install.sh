...
wget https://codeload.github.com/lingyongji/libsodium/tar.gz/1.0.16
...
wget -N --no-check-certificate -O /usr/local/bin/ssr https://raw.githubusercontent.com/${GH_REPO}//SSR-Bash-Python/master/ssr
